...
SDT_PROFILES_DIR = os.path.join(REPO_ROOT, "Stand-der-Technik-Bibliothek/Nutzergenerierte-Inhalte/", "profile")
SDT_COMPONENTS_DE_DIR = os.path.join(SDT_OUTPUT_DIR, "komponenten/DE")
SDT_COMPONENTS_GPP_DIR = os.path.join(REPO_ROOT, "Stand-der-Technik-Bibliothek/Nutzergenerierte-Inhalte/", "komponenten")
